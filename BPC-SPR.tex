...
\newcommand{\subtitle}{Otázky a odpovědi na SW právo.}      % Popis dokumentu - Nepovinný
\author{jedla97}                                            % Autor           - Nepovinný
...
\sectionfont{\fontsize{12}{15}\sffamily\selectfont}       % formát nadpisů otázek
\renewcommand{\cfttoctitlefont}{\Large\bfseries\sffamily} % formát nadpisu v Obsahu
\renewcommand{\cftsecfont}{\rmfamily}                     % formát nadpisů v obsahu
